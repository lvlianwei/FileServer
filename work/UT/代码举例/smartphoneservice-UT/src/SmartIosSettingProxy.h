/*
 * SmartIosSettingProxy.h
 *
 *  Created on: 2017年4月23日
 *      Author: zjh
 */

#ifndef SMARTIOS_SETTINGPROXY_H_
#define SMARTIOS_SETTINGPROXY_H_
#include <vector>
...
class SmartIosSettingProxy {
    public:
		#ifdef UT_GTEST_FULL_ENG
		virtual void ForLocalFunc();
		virtual void ForSetLocalValue(int count);
		virtual int ForGetLocalValue();
		#endif
        ...
        /**
            ...
            */
        virtual int setPopStatusReq(SmtSetType setType,  uint8_t index, SmtPopStatus setting, SmtDeviceType deviceType);
        /**
            ...
            */
        virtual uint8_t  iapDeviceInsert(const char* serialNum,  uint8_t* selectStatus, SmtDeviceType deviceType);
        /**
            ...
            * @return 
            */
        virtual bool getDeviceInfo(SmtDevReqType reqType, uint8_t index, std::vector<IosDeviceName*>  *mDevList, SmtDeviceType deviceType);
        /**
            ...
            */
        virtual void setDeviceName(const char * serinum,const char * devname, SmtDeviceType deviceType);
        /**
    ...
    private:
        ...
        /**
            ...
            * @return max priority
            */
        virtual int getNoPopStatusDeviceMaxPriority(SmtDeviceType deviceType);
        /**
            * @brief getPopDeviceMaxPriority ,get current all pop device max priority
            *
            * @return max priority
            */
        virtual int getPopDeviceMaxPriority(SmtDeviceType deviceType);
        /**
            ...
            */
        virtual void updateNoPopStatusDevicesPriority(int priority, SmtDeviceType deviceType);
        /**
        ...
        /**
            ...
            */
        virtual void replacePopDevice(const char * serialNum,uint8_t popValue,const char* devname,uint8_t nameIsValid,uint8_t nonameindex, SmtDeviceType deviceType);
        /**
            ...
            * @param index
            */
        virtual void replaceNoPopDevice(const char* serialNum,uint8_t popValue,const char * devname,uint8_t nameIsValid,uint8_t nonameindex,uint8_t& index, SmtDeviceType deviceType);
        virtual bool deleteNoPopDevice(uint8_t index, SmtDeviceType deviceType);
        virtual bool insertPopDevice(IosDeviceName* devname, SmtPopStatus setting, int maxPriority, SmtDeviceType deviceType);
        virtual bool insertPopDeviceNoName(IosDeviceName* devname, SmtPopStatus setting, int maxPriority, SmtDeviceType deviceType);

    public:
    private:
        SmartIosSettingProxy(const SmartIosSettingProxy& );
        SmartIosSettingProxy &operator=(const SmartIosSettingProxy&);
    private:
        /**
