...
public:
    ...
    android::status_t wfd_sourceChange(SenderId id, const uint8_t& mode){return 0;}
    android::status_t wfd_mirrorMode(SenderId id, const MirrorMode& mode){return 0;}
    android::status_t wfd_SreenMode(SenderId id, const ScreenMode& mode){return 0;}
    android::status_t wfd_startSearch(SenderId id){return 0;}
    android::status_t wfd_stopSearch(SenderId id){return 0;}
    android::status_t wfd_acceptInvitation(SenderId id, const bool& accept, uint64_t macAddr){return 0;}
    android::status_t wfd_disconnect(SenderId id){return 0;}
    android::status_t wfd_getGPSTime(SenderId id){return 0;}
    android::status_t wfd_sendHardKey(SenderId id, const HardKey& key);
    android::status_t wfd_p2pDisconnect(){return 0;}
    android::status_t wfd_getP2pState(){return 0;}
    android::status_t wfd_play(){return 0;}
    android::status_t wfd_pause(){return 0;}
    android::status_t wfd_sendIDR(){return 0;}

    android::status_t onInvitationInd(android::String8 devName, uint64_t macAddr){return 0;}

    android::status_t onP2pPowerStatusNotify(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onP2pConnectStatusNotify(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onP2pConnectedInfoNotify(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onP2pLinkQuiltyNotify(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onP2pListenStatusNotify(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onBtConnectionChanged(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onBtDisconnectionChanged(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onStaConnectedInfoNotify(WFDServiceMsg* recvMsg){return 0;}
    android::status_t onCarLifeOrCarPlayInsert(){return 0;}
    android::status_t onCarLifeOrCarPlayExtract(){return 0;}
    android::status_t onTransSwitchReq(uint32_t protocl){return 0;}
    android::status_t onTransSwitchCmp(uint32_t result){return 0;}
